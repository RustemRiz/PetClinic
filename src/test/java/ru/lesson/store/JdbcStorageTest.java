...
//        assertEquals(petName, currentClient.getPets().getName());
//        assertEquals(PetType.CAT, currentClient.getPets().getPetType());
//        cache.delete(id);
